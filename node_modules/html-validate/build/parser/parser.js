...
class Parser {
    ...
    parseHtml(source) {
        ...
        this.dom = new dom_1.DOMTree({
            filename: (_a = source.filename, (_a !== null && _a !== void 0 ? _a : "")),
            offset: (_b = source.offset, (_b !== null && _b !== void 0 ? _b : 0)),
            line: (_c = source.line, (_c !== null && _c !== void 0 ? _c : 1)),
            column: (_d = source.column, (_d !== null && _d !== void 0 ? _d : 1)),
        });
